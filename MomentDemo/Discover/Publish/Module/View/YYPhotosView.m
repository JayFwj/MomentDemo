...
#define ImgCountRow 3 // 每行图片数量
#define ImageMargin 5 // 图片之间间距
...
- (void)addImages:(NSMutableArray *)images {
    ...
    CGFloat imgW = 90;//(self.ml_width - (self.imgCountRow + 1) * ImageMargin) / self.imgCountRow;
    CGFloat imgH = imgW;
    ...
    self.superImgView.frame = CGRectMake(0, 0, self.ml_width, self.imageMaxHeight + ImageMargin);
...
- (void)deleteBtnClick:(UIButton *)button {
    ...
    [self.delegate didDeletePhoto:self.imgArr];
}

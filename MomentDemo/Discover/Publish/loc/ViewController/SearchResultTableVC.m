...
@interface SearchResultTableVC() <AMapSearchDelegate>
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    [text addAttribute:NSForegroundColorAttributeName value:[UIColor MainColor] range:textHighlightRange];
    ...
    [detailText addAttribute:NSForegroundColorAttributeName value:[UIColor MainColor] range:detailTextHighlightRange];
...
- (void)updateFrame{
    if (@available(iOS 11.0, *)) {
        if (self.view.safeAreaInsets.top == 0) {
            CGRect tempFrame = self.view.superview.frame;
            self.view.superview.frame = CGRectMake(0, TopNavHeight, SCREEN_WIDTH, CGRectGetHeight(tempFrame));
        }

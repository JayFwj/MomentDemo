...
+ (NSString *)convertToNormalTimeWithDate:(NSDate *)date language:(NSDateNormalTimeLanguage) language
{
    ...
    if (date.isToday) {
        if (hasAMPM) {
            format.AMSymbol = NSLocalizedString(@"AM", @"History");
            format.PMSymbol =  NSLocalizedString(@"PM", @"History");
        ...
        return NSLocalizedString(@"Yesterdy", @"History");
    }
...
+ (NSString *)weekDayStrWithInteger:(NSUInteger)weekDayInt language:(NSDateNormalTimeLanguage) language
{
    ...
    switch (weekDayInt)
    {
        case 1:
        {
            weekdayStr = NSLocalizedString(@"Sunday", @"History");
        }break;
        case 2:
        {
            weekdayStr = NSLocalizedString(@"Monday", @"History");
        }break;
        case 3:
        {
            weekdayStr = NSLocalizedString(@"Tuesday", @"History");
        }break;
        case 4:
        {
            weekdayStr = NSLocalizedString(@"Wednesday", @"History");
        }break;
        case 5:
        {
            weekdayStr = NSLocalizedString(@"Thursday", @"History");
        }break;
        case 6:
        {
            weekdayStr = NSLocalizedString(@"Friday", @"History");
        }break;
        case 7:
        {
            weekdayStr = NSLocalizedString(@"Saturday", @"History");
        }break;
        default:
            break;
    }
...
+ (NSString *)convertWithDate:(NSDate *)date language:(NSDateNormalTimeLanguage) language
{
    ...
    NSTimeInterval showTimestamp = [date timeIntervalSince1970];
    if (date.isToday) {
        return NSLocalizedString(@"Today", @"History");
    }
    else if (date.isYesterday) {
        return NSLocalizedString(@"Yesterdy", @"History");
    }
